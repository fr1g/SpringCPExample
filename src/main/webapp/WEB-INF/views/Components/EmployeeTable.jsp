...
%>
<div id="rely" class="p-3 bg-slate-200 rounded-lg overflow-y-hidden overflow-x-auto" >
    <div class="w-full min-w-[50vw] max-w-[100vw]">
        <%=result%>
    </div>
</div>
<div id="control" class="w-full grid grid-cols-3 gap-3 p-3.5 bg-slate-100/90 rounded-lg hover:bg-slate-100 transition " >
