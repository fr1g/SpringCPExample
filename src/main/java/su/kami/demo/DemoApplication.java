...
//		builder.registerTypeAdapter(Employee.class, new GsonRelatedObjectHelper<Employee>((EmployeeManage)SharedStatics.dynamicShared.services.get("EmployeeService").lendAgent()));
